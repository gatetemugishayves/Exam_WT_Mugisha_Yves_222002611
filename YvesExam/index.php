...
<body style="background-image: url('./images/eat.png');background-repeat: no-repeat;background-size: cover;">

<div class="overlay">
  <div class="container">
    <h1 style="color: pink;">WELCOME TO EMPLOYEES ATTENDANCE TRACKER</h1>
